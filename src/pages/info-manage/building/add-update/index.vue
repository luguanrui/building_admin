    ...
    <div class="wrapper">
      <a-form-model ref="form" :model="form" :rules="rules" :label-col="labelCol" :wrapper-col="wrapperCol" :layout="'horizontal'">
        <a-row>
          ...
          <a-col :span="span">
            <a-form-model-item label="建设单位" prop="aa">
              <!-- <span v-if="disabled">{{ form.aa }}</span>
          ...
          <a-col :span="span">
            <a-form-model-item label="地址" prop="aa">
              <span v-if="disabled">{{ form.aa }}</span>
              <a-input v-else v-model="form.aa" placeholder="请输入" allowClear :maxLength="200" />
            </a-form-model-item>
          </a-col>
          <a-col :span="span">
            <a-form-model-item label="物业公司" prop="aa">
              <span v-if="disabled">{{ form.aa }}</span>
              <a-input v-else v-model="form.aa" placeholder="请输入" allowClear :maxLength="200" />
            </a-form-model-item>
          </a-col>
          ...
          <a-col :span="span">
            <a-form-model-item label="主楼" prop="aa">
              <span v-if="disabled">{{ form.aa }}</span>
              <a-input v-else v-model="form.aa" placeholder="请输入" allowClear :maxLength="200" />
            </a-form-model-item>
          </a-col>
          <a-col :span="span">
            <a-form-model-item label="单身公寓" prop="aa">
              <!-- <span v-if="disabled">{{ form.aa }}</span>
              <a-select v-else v-model="form.aa" placeholder="请选择" allowClear :getPopupContainer="(trigger) => trigger.parentNode" :dropdownMatchSelectWidth="false">
                <a-select-option v-for="item in industryList" :value="item.key" :key="item.item">
                  {{ item.value }}
          ...
          <a-col :span="span">
            <a-form-model-item label="副楼" prop="aa">
              <span v-if="disabled">{{ form.aa }}</span>
              <a-input v-else v-model="form.aa" placeholder="请输入" allowClear :maxLength="200" />
            </a-form-model-item>
          </a-col>
