<template>
  <a-card class="import-wrapper">
    ...
    <!-- 导入 -->
    <a-modal v-model="visible" title="导入数据" @ok="handleConfirmImport" :maskClosable="false">
      <div class="step">
        <h5>使用模板并按照要求填写</h5>
...
export default {
  ...
  computed: {
    ...
    templateUrl() {
      return `http://115.238.32.56:8080/file/prod/test/2021-01-02/f27a500e-e9ae-4328-ba6a-95689d251a97.xlsx?sessionId=${localStorage.getItem('buildSessionId')}`
    },
  },
  activated() {
